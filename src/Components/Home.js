      ...
      <div className=" flex  max-w-screen-lg flex-col mx-auto h-full justify-center items-center  px-4 md:flex-row  ">
        <div className="text-white ">
          ...
          <p className="text-gray-500">
            I'm vineeth, a final-year BTech student at Kitsw College, deeply
            passionate about the software field, particularly in crafting
            innovative web applications using technologies like React and CSS
          </p>
          <div className=" w-40">
            <Link
              to="Portfolio"
